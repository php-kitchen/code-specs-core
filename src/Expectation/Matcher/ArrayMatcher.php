...
class ArrayMatcher extends ValueMatcher {
    public function hasKey($key) {
        $this->startStep('has key "' . $key . '"')->assertArrayHasKey($key);
        return $this;
    }

    public function doesNotHaveKey($key) {
        $this->startStep('does not have key "' . $key . '"')->assertArrayNotHasKey($key);
        return $this;
    }

    public function hasSubset($subset, $subsetName = '') {
        $stepName = $subsetName ? "has subset \"{$subsetName}\"" : 'has expected subset';
        $this->startStep($stepName)->assertArraySubset($subset, false);
        return $this;
    }
    ...
    public function hasExactlyTheSameSubset($subset, $subsetName = '') {
        ...
        $this->startStep($stepName)->assertArraySubset($subset, true);
        return $this;
    }
    ...
    public function hasSameSizeAs($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertSameSize($expected);
        return $this;
    }
    ...
    public function doesNotHaveSameSizeAs($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertNotSameSize($expected);
        return $this;
    }
    ...
    public function contains($needle, $needleName = '') {
        ...
        $this->startStep($stepName)->assertContains($needle);
        return $this;
    }
    ...
    public function doesNotContain($needle, $needleName = '') {
        ...
        $this->startStep($stepName)->assertNotContains($needle);
        return $this;
    }

    public function containsOnlyValuesOfType($type) {
        $this->startStep('contains only values of type "' . $type . '"')->assertContainsOnly($type);
        return $this;
    }

    public function containsOnlyValuesOfNativeType($type) {
        $this->startStep('contains only values of native type "' . $type . '"')->assertContainsOnly($type, true);
        return $this;
    }

    public function containsOnlyInstancesOf($class) {
        $this->startStep('contains only instances of "' . $class . '"')->assertContainsOnlyInstancesOf($class);
        return $this;
    }

    public function doesNotContainOnlyValuesOfType($type) {
        $this->startStep('does not contain only values of type "' . $type . '"')->assertNotContainsOnly($type, null);
        return $this;
    }
    ...
    public function countIsEqualToCountOf($countOrCountable, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertCount($this->convertToCount($countOrCountable));
        return $this;
    }
    ...
    public function countIsNotEqualToCountOf($countOrCountable, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertNotCount($this->convertToCount($countOrCountable));
        return $this;
    }
