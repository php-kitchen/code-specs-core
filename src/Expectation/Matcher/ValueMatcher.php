...
class ValueMatcher extends Matcher {
    public function isInternalType($type): self {
        $this->startStep('is internal type "' . $type . '"')->assertInternalType($type);
        return $this;
    }

    public function isNotInternalType($type): self {
        $this->startStep('is not internal type "' . $type . '"')->assertNotInternalType($type);
        return $this;
    }
    ...
    public function isEqualTo($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertEquals($expected);
        return $this;
    }
    ...
    public function isNotEqualTo($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertNotEquals($expected);
        return $this;
    }

    public function isGreaterThan($expected): self {
        $this->startStep('is greater than "' . $expected . '"')->assertGreaterThan($expected);
        return $this;
    }

    public function isLessThan($expected): self {
        $this->startStep('is less than "' . $expected . '"')->assertLessThan($expected);
        return $this;
    }

    public function isGreaterOrEqualTo($expected): self {
        $this->startStep('is greater or equal to "' . $expected . '"')->assertGreaterThanOrEqual($expected);
        return $this;
    }

    public function isLessOrEqualTo($expected): self {
        $this->startStep('is less or equal to "' . $expected . '"')->assertLessThanOrEqual($expected);
        return $this;
    }

    public function isNull(): self {
        $this->startStep('is null')->assertNull();
        return $this;
    }

    public function isNotNull(): self {
        $this->startStep('is not null')->assertNotNull();
        return $this;
    }

    public function isEmpty(): self {
        $this->startStep('is empty')->assertEmpty();
        return $this;
    }

    public function isNotEmpty(): self {
        $this->startStep('is not empty')->assertNotEmpty();
        return $this;
    }
    ...
    public function isTheSameAs($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertSame($expected);
        return $this;
    }
    ...
    public function isNotTheSameAs($expected, $expectedValueName = '') {
        ...
        $this->startStep($stepName)->assertNotSame($expected);
        return $this;
    }
}